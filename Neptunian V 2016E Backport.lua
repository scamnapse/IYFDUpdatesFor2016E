...
--// yeah maybe that above thing doesnt age well, vengefulprogram was exposed for being a pedophile or something i forgot.
--// anyways neptunian v backport to 2016 or something made by me, scamnapse!
--// thanks louknt/check cashed for findfirstchildofclass lol
--// Neptunian V 2016E will be released since its (mostly) bug free, only bug is when you use the x key, for some reason it turns you onto your side, tho usiing ur main attack fixes it, i do not know why this happens.
--// Managed to get this as far back as september 2014 LMAOOOOOOOO
...
local currentenv = getfenv() --// in case you dont have getgenv lol
currentenv.LoadLibrary = function(Lib)
return loadstring(game:HttpGet("https://raw.githubusercontent.com/Roblox/Core-Scripts/refs/heads/master/CoreScriptsRoot/Libraries/"..Lib..".lua"))()
end
...
Part365.Material = Enum.Material.SmoothPlastic
...
function lerp(object, property, targetCFrame, alpha)
    local startCFrame = object[property]
    object[property] = clerp(startCFrame, targetCFrame, alpha)
end
...
function Damagefunc(Part, hit, minim, maxim, knockback, Type, Property, Delay, HitSound, HitPitch)
  ...
  local h = FindFirstChildOfClass(hit.Parent, "Humanoid")
